...
\begin{figure}[h]
	\begin{center}
		...
		\end{subfigure}
	\end{center}
	\caption{Coloration de Nissl}{\subref{fig:FemWTNissl} Femelle sauvage. \subref{fig:FemMutNissl} Femelle mutante. \subref{fig:MaleWTNissl} Mâle sauvage. \subref{fig:MaleMutNissl} Mâle mutant. Âge moyen des souris : 30 jours. Barre d'échelle : 2 mm.}
