...
%				\caption{}
%				\label{fig:locaMuSK}
%				\includegraphics[width=\textwidth]{./Images/Immuno/loca_MuSK.jpg}
%			\end{subfigure}
%			\begin{subfigure}[h]{0.33\textwidth}
%				\caption{}
%				\label{fig:locaMuSKcc}
%				\includegraphics[width=\textwidth]{./Images/Immuno/MuSK_cc.jpg}
%			\end{subfigure}
%			\begin{subfigure}[h]{0.33\textwidth}
%				\caption{}
%				\label{fig:locaMuSKcp}
%				\includegraphics[width=\textwidth]{./Images/Immuno/MuSK_cp.jpg}
%			\end{subfigure}
%			\begin{subfigure}[h]{0.32\textwidth}
%				\caption{}
%				\label{fig:locaMuSKfr}
%				\includegraphics[width=\textwidth]{./Images/Immuno/MuSK_fr.jpg}
%			\end{subfigure}
		\end{center}
...
%				\subref{fig:locaMuSKcc} : Marquage \gls{musk} dans le corps calleux. %
%				\subref{fig:locaMuSKcp} : Marquage \gls{musk} dans le pédoncule cérébral. %
%				\subref{fig:locaMuSKfr} : Marquage \gls{musk} dans le fasciculus retroflexus. %
...
%				\caption{}
%				\label{fig:MuskE5WT}
%				\includegraphics[width=\textwidth]{./Images/Immuno/Musk/E5WT.jpg} %Gel anti light chain
%			\end{subfigure}
%			\begin{subfigure}[h]{0.49\textwidth}
%				\caption{}
%				\label{fig:MuskE1KO}
%				\includegraphics[width=\textwidth]{./Images/Immuno/Musk/E1KO.jpg} %Gel anti light chain
%			\end{subfigure}
%		\end{center}
%		\caption{Marquage de \gls{musk} sur Embryon E18.5 WT et KO}
%		\descfig{arg1}
