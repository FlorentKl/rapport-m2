...
\label{sec:NisslResultat}
	...
	\begin{figure}[h] %Figure Nissl Résultats
		...
		\descfig{%
			Coloration de Nissl sur : \subref{fig:FemWTNissl} Femelle sauvage, \subref{fig:FemMutNissl} Femelle mutante, \subref{fig:MaleWTNissl} Mâle sauvage, \subref{fig:MaleMutNissl} Mâle mutant. 
	...
	\begin{figure}[h]
		\begin{center}
			...
			\begin{subfigure}[h]{0.49\textwidth}
				\missingfigure{Table Resultats Mesure NeuN}
			\end{subfigure}
		\end{center}
		\caption{NeuN}
		\descfig{%
				Marquage de \gls{neun} sur tranche de cerveau. Illustration des différentes profondeurs choisies pour les mesures.
...
\section{Localisation et identification des cellules neurales exprimant \acrshort{musk}}
	...
	\todo{Ajouter controle a coté pour montrer que pas que bruit, ainsi que zoom sur diverses régions}
	\begin{figure}[h] %Figure Immuno MuSK Résultats
		...
		\descfig{%
			Immunomarquage de \gls{musk} sur coupe de cerveau entière.%
...
\label{sec:ExpressionMuSK}
	...
	Par manque d'individus au moment de l'expérience, je n'ai pas pu tester les conditions mâles \emph{versus} femelles. On peut voir que l'expression 
	...
	\begin{figure}[h]
		...
		\descfig{%
				...
				HG : Hippocampe Gauche, HD : Hippocampe Droit, Ct : Cervelet. n = 3 (\gls{wt}) et n = 4 (mutants). Test statistique : Test t de Student non apparié (\subref{fig:qPCRCompaWTMut}), et Test t de Student apparié (\subref{fig:qPCRCompaWT} \& \subref{fig:qPCRCompaMut}). * : p<0.05, ** : p<0.01, *** : p<0.001. 
				}
