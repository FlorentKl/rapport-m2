...
\label{sec:IHC}
	...
	\begin{figure}[h] %Marquage MuSK GFAP
		\begin{center}
			\begin{subfigure}[h]{0.99\textwidth}
				\missingfigure{Schéma recap MuSK/tranche cerveau entière annotée}
			\end{subfigure}
			\begin{subfigure}[h]{0.33\textwidth}
				\missingfigure{Orga hipp}
			\end{subfigure}
			\begin{subfigure}[h]{0.33\textwidth}
				\missingfigure{Orga CC}
			\end{subfigure}
			\begin{subfigure}[h]{0.33\textwidth}
				\missingfigure{Orga Etc}
			\end{subfigure}
		\end{center}
	\end{figure}
	...
	\begin{figure}[h] %Marquage MuSK
		\begin{center}
			\begin{subfigure}[h]{0.49\textwidth}
				\missingfigure{Colocalisation MuSK GFAP Tranche}
			\end{subfigure}
			\begin{subfigure}[h]{0.49\textwidth}
				\missingfigure{colocalisation culture cell}
			\end{subfigure}
		\end{center}
	\end{figure}
