	...
	\begin{figure}[h] %Figure Immuno MuSK Résultats
		...
		\descfig{%
			...
			\subref{fig:locaMusKCtrl} Coupe contrôle du marquage de \gls{musk} dans un cerveau de souris \mcrd. Aucun marquage n'apparaît. %
			 alv : alveus hippocampus, cc : corps calleux, cp : pédoncule cérébral, ec : capsule externe, fr : fasciculus retroflexus, hp : hippocampe, mHb : Habenula médiale, or : stratum oriens de l'hippocampe. Barre d'échelle : 2 mm (\subref{fig:locaMusK}, \subref{fig:locaMusKCtrl}), 50µm (\subref{fig:locaMuSKcc}- \subref{fig:locaMuSKfr}).
			 	}
