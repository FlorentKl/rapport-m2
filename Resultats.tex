...
Cette coloration a été réalisée afin de visualiser si la mutation \mcrd altérait l'organisation structurale du cerveau.\todo{Nissl résultats à finir}
...
\begin{figure}[h]
	...
	\descfig{\subref{fig:FemWTNissl} Femelle sauvage. \subref{fig:FemMutNissl} Femelle mutante. \subref{fig:MaleWTNissl} Mâle sauvage. \subref{fig:MaleMutNissl} Mâle mutant. Images représentatives issues de la région autour de l'hippocampe. Âge moyen des souris : 30 jours. Barre d'échelle : 2 mm.}
