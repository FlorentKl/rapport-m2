...
\FloatBarrier
	...
	Afin d'identifier plus précisément le type de cellules exprimant \gls{musk}, un co-marquage entre le récepteur et des marqueurs cellulaire a été réalisé sur des cultures primaires d'hippocampes issues d'embryon au stade E16, cultivées 14 jours, fourni par D. Carrel. Les marqueurs cellulaires vont être : \gls{gfap} pour les astrocytes et \gls{map2} pour marquer les dendrites des neurones. J'ai également testé un co-marqueg \gls{musk} et \gls{glt1}, marqueur membranaire astrocytaire d'un transporteur du glutamate afin de voir si \gls{musk} était localisé à la membrane, mais ce marquage n'a pas fonctionné.
	...
	\descfig{%
					...
					\subref{fig:CultureMMmap2musk} Merge
