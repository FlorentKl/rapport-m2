...
\label{sec:NisslResultat}
	...
	\label{ssec:neun}
		...
		\begin{figure}[h]
			...
			\end{subfigure}
			\caption{La distribution des neurones dans l'hippocampe est modifiée par la mutation \mcrd.}
			\descfig{%
					...
					\subref{fig:hippIllu} Schéma des régions CA1, CA3, et DG 1 (zone infrapyramidale) \& 2 (zone suprapyramidale) dans lesquelles sont effectuées les mesures. Issue de Li et Pleasure, 2013 \cite{Li2013a}.
...
\section{Localisation et identification des cellules neurales exprimant \acrshort{musk}}
	...
	\begin{figure}[h] %Figure Immuno MuSK Résultats
		...
		\descfig{%
			\subref{fig:locaMusK} Immunomarquage de \gls{musk} sur coupe de souris mutante %
			\subref{fig:locaMusKwt} Immunomarquage de \gls{musk} sur coupe de souris sauvages. %
			...
			\subref{fig:locaMusKCtrl} Coupe contrôle du marquage de \gls{musk} dans un cerveau de souris \mcrd. Aucun marquage n'apparaît. %
			 alv : alveus hippocampus, cc : corps calleux, cp : pédoncule cérébral, ec : capsule externe, fr : fasciculus retroflexus, hp : hippocampe, mHb : Habenula médiale, or : stratum oriens de l'hippocampe. Barre d'échelle : 2 mm (\subref{fig:locaMusK}, \subref{fig:locaMusKwt}), 50µm (\subref{fig:locaMuSKcc}- \subref{fig:locaMuSKfr}).
			 	}
	...
	\begin{figure}[h]
		...
		\end{subfigure}
		\caption{\gls{musk} et \gls{gfap} colocalisent dans les mêmes cellules.}
		\descfig{%
...
%\FloatBarrier
	...
	\begin{figure}[h]
		\begin{center}
			...
			\end{subfigure}
		\end{center}
		\caption{Marquage de \gls{musk} sur coupes d'embryon E18.5 \gls{musk} \Acrshort{wt}, absent chez les embryons \gls{musk} KO.}
		\descfig{%
			Marquage de \gls{musk} et \gls{gfap} sur des embryons (stade E18.5) de souris \gls{musk} KO (n = 2) et WT (n = 1). Aucun marquage de \gls{gfap} n'est visible, la \acrshort{gfap} étant principalement exprimée après la naissance. %
			\subref{fig:MuskE5WT} Embryon WT. Un marquage ressemblant à celui de \gls{musk} observé chez les adultes était parfois présent (flèches blanches). %
...
\label{sec:IPresultat}
	...
	\begin{figure}[h]
		...
		\descfig{%
			\subref{fig:WB-anti-LC} \gls{ip} suivie de \gls{wb} sur 3 souris C57BL/6 révélée avec un anticorps dirigé contre les chaînes légères d'\gls{ig} de lapin. Seule la bande témoin aux alentours de 130kDa est révélée. Exposition : 30 minutes. %
			\subref{fig:WBbon} \gls{ip} suivie de \gls{wb} sur 3 souris C57BL/6. Des bandes sont révélées aux alentours de 110kDa pour les régions de l'hippocampe et du cervelet (flèches noires). Une bande de faible intensité semble être présente pour le cortex (tête de flèche noire). Témoin positif : 15µL d'extrait cellulaire de cellules HEK293 transfectées, bande à 130kDa (flèche blanche). Exposition : 3 minutes. %
			...
			\subref{fig:WBpasbon} \gls{ip} suivie de \gls{wb} sur 3 souris \mcrd (Mut) et 3 souris sauvages (WT) issues de la même souche. Aucune bande n'est révélée, avec ou sans anticorps durant \gls{ip}. Aucune bande n'est révélée non plus chez le témoin positif : Extrait de cervelet et cortex issus de la première expérience. Hipp : Hippocampe, Ct : Cervelet, Cx : Cortex, + : Témoin positif, Ac- : Sans anticorps lors de l'\gls{ip}, Mut : Mutant, \acrshort{wt} : Sauvage. Poids moléculaire de \gls{musk} attendu : 110kDa. Exposition : 3 minutes. %
				}
