...
\label{par:genotypage}
	Les animaux sont génotypés à l'âge de 7 jours par prélèvement d'un doigt d'une patte avant. L'extraction d'\acrshort{adn} se fait par lyse alcaline (NaOH 25mM) à 95°C pendant 20 minutes puis ajout de Tris-HCl 40mM. Une \gls{pcr} est réalisée avec les couples de primers Ef et Lxr  pour les individus ??? \todo{wt ou mut ?}, et Ef et Wr pour les individus ???\todo{idem ?} (voir \cref{table:génotypage} pour les séquences des primers utilisés). Dépôt des produits de \gls{pcr} dans un gel d'agarose 2\% et migration à 200V pendant 10 minutes. Révélations des bandes aux ultraviolets après coloration des acides nucléiques avec du \acrshort{bet}.
