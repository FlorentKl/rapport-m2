...
\label{sec:IntroSynapse}
	...
	Ainsi, l'acteur majeur du développement de la synapse neuromusculaire est donc \gls{musk}, qui sert de plateforme de signalisation à la fois durant les étapes de pré-patterning, puis durant les étapes plus tardives de mise en place et de maturation de la synapse.
