...
\section{Récépteur MuSK}
	...
	La partie extracellulaire comporte généralement trois domaines \gls{ig}, dont le domaine \gls{ig}1 a récemment été impliqué dans la liaison avec \gls{lrp}4 \cite{Zhang2011}, ainsi qu'un domaine Frizzled-like, riche en cystéines (\gls{crd}).
	...
	On sait désormais, grâce à des techniques de knockdown du gène, que la présence de \gls{musk} dans le cerveau est nécessaire, mais non indispensable, à la formation de la mémoire, au travers de la voie \acrshort{creb} : l'absence de \gls{musk} va empêcher la phosphorylation de \gls{creb}. \todo{faire lien avec voie CREB, phosphorylation et formation de la mémoire} 
